                  ...
                  <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Hi {{$data['name']}},</p>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We received a request to reset the password associated with your account. To ensure the security of your account, please follow the instructions below to reset your password.</p>
                      <br />
                      ...
                      <br>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"> Please note that the OTP code provided above. If you do not reset your password within this time frame, you may need to request a new OTP. <br></p>
                      <br>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"> If you did not initiate this password reset request or believe this email was sent to you by mistake, please ignore it and accept our apologies for any inconvenience caused.<br></p>
                      <br>
